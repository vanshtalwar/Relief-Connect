      ...
      {step === 1 && (
        <div className="animate-in fade-in slide-in-from-right-4 duration-300">
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center text-xs uppercase"><span className="bg-[color:var(--surface)] sm:bg-[color:var(--panel)] px-2 text-[color:var(--foreground)]/50 font-medium">Or</span></div>
          </div>
